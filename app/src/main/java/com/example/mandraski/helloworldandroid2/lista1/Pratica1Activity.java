...
public class Pratica1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.btExercicio2P1) {
            startActivity(new Intent(this, Exercicio2P1Activity.class));
        }

        if (i == R.id.btExercicio3P1) {
            startActivity(new Intent(this, Exercicio3P1Activity.class));
        }

        if (i == R.id.btExercicio4P1) {
            startActivity(new Intent(this, Exercicio4P1Activity.class));
        }
